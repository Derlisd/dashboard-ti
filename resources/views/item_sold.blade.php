...
<div class="container">
        <div class="form-row mb-2">
            <div class="col-10">
                <textarea cols="30" rows="1" class="form-control" name="query" id="query"> SELECT * FROM itemSold limit 100;</textarea>
            </div>
           ...
           <table id="tablaDatos" class="table">
                <thead>
                    <tr>
                        ...
                        <th>itemSoldDate</th>
                        <th>itemSoldUnits</th>
                        <th>itemSoldDiscount</th>
                        <th>itemSoldCOGS</th>
                        <th>itemSoldComission</th>
                        <th>itemSoldDescription</th>
                        <th>itemSoldParent</th>
                        <th>itemSoldCategory</th>
                        <th>itemId</th>
                        <th>userId</th>
                        <th>transactionId</th> <th>itemSoldId</th>
                        <th>itemSoldTotal</th>
                        <th>itemSoldTax</th>
                        <th>itemSoldDate</th>
                        <th>itemSoldUnits</th>
    ...
    <script>
        ...
        const buildTableItem = (data) =>{
            TABLE = $('#tablaDatos').DataTable({
                ...
                columns: [
                    ...
                    { data: 'itemSoldId', name: 'itemSoldId' },
                    { data: 'itemSoldTotal', name: 'itemSoldTotal' },
                    { data: 'itemSoldTax', name: 'itemSoldTax' },
                    { data: 'itemSoldDate', name: 'itemSoldDate' },
                    { data: 'itemSoldUnits', name: 'itemSoldUnits' },
                    { data: 'itemSoldDiscount', name: 'itemSoldDiscount' },
                    { data: 'itemSoldCOGS', name: 'itemSoldCOGS' },
                    { data: 'itemSoldComission', name: 'itemSoldComission' },
                    { data: 'itemSoldDescription', name: 'itemSoldDescription' },
                    { data: 'itemSoldParent', name: 'itemSoldParent' },
                    { data: 'itemSoldCategory', name: 'itemSoldCategory' },
        ...
        const validateOperacion= async (query) =>{
            ...
            try {
                ...
                method: 'POST',
                data:{'campo_query' : query, 'modulo':'itemSold'},
        ...
        $('#tablaDatos').on('click', '.editar', function() {
            ...
            DATA_UPDATE['itemSoldId'] = row.cell(tr.find('td:nth-child(2)')).data(); // Obtiene el valor de la segunda columna
